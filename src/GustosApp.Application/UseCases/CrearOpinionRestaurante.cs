...
namespace GustosApp.Application.UseCases.RestauranteUseCases
{
    public class CrearOpinionRestaurante
    {
        ...
        public async Task HandleAsync(Guid usuarioId, Guid restauranteId, int valoracionUsuario, string opinion, string titulo, string img, DateTime fechaVisita, CancellationToken cancellationToken)
        {
